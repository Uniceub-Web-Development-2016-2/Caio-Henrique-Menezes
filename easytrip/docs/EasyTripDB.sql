...
--
-- Host: localhost
-- Tempo de geração: 26/11/2016 às 17:31
...
--
-- Banco de dados: `EasyTripDB`
--

-- --------------------------------------------------------

--
-- Estrutura para tabela `accomodation`
--
...
INSERT INTO `city` (`id`, `cityName`, `codState`) VALUES
(1, 'Afonso Cláudio', 8),
...
INSERT INTO `country` (`id`, `countryName`, `countryIni`) VALUES
(1, 'Brasil', 'BRA'),
...
INSERT INTO `local` (`id`, `localName`, `description`, `codCity`, `codUser`) VALUES
(1, 'Casa', 'Casa Admin', 882, 1);
...
INSERT INTO `state` (`id`, `stateName`, `stateIni`, `codCountry`) VALUES
(1, 'Acre', 'AC', 1),
(2, 'Alagoas', 'AL', 1),
(3, 'Amazonas', 'AM', 1),
(4, 'Amapá', 'AP', 1),
...
CREATE TABLE `user` (
  ...
  `positionLat` varchar(30) DEFAULT NULL,
  `positionLgn` varchar(30) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `user` (`id`, `name`, `dteBirth`, `register`, `profile`, `email`, `username`, `pwd`, `active`, `positionLat`, `positionLgn`) VALUES
(1, 'admin', '2000-01-01', '001002003-04', 'A', 'admin@easytrip.com', 'admin', 'admin123', 'Y', '', '0'),
(2, 'Teste', '2016-10-25', '666.583.619-32', 'a', 'teste.123@teste.br', 'tester', '123', 'y', '-19', '-33'),
(5, 'teste1', '0000-00-00', '', 'u', 'teste1@teste.com', 'teste1', '$2y$11$e4908cede76beee45de67Ox1.qhZWGk2WAGhbP', 'y', NULL, NULL);
...
--
-- Índices de tabela `accomodation`
--
ALTER TABLE `accomodation`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Accomodation_Local1_idx` (`CodLocal`);
...
ALTER TABLE `city`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_City_State1_idx` (`codState`);
...
ALTER TABLE `local`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Local_City1_idx` (`codCity`),
  ADD KEY `fk_Local_User1_idx` (`codUser`);
...
ALTER TABLE `state`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_State_Country1_idx` (`codCountry`);
...
--
-- AUTO_INCREMENT de tabela `accomodation`
--
ALTER TABLE `accomodation`
...
--
-- Restrições para tabelas `accomodation`
--
ALTER TABLE `accomodation`
  ADD CONSTRAINT `fk_Accomodation_Local1` FOREIGN KEY (`CodLocal`) REFERENCES `local` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Restrições para tabelas `city`
--
ALTER TABLE `city`
  ADD CONSTRAINT `fk_City_State1` FOREIGN KEY (`CodState`) REFERENCES `state` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Restrições para tabelas `local`
--
ALTER TABLE `local`
  ADD CONSTRAINT `fk_Local_City1` FOREIGN KEY (`CodCity`) REFERENCES `city` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Local_User1` FOREIGN KEY (`CodUser`) REFERENCES `tb_user` (`IdUser`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Restrições para tabelas `state`
--
ALTER TABLE `state`
  ADD CONSTRAINT `fk_State_Country1` FOREIGN KEY (`CodCountry`) REFERENCES `country` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
